...
app.post('/api/updatePayment', async (req, res) => {
  try {
    ...
    const { userId, coachId, date, time, paymentProof, amount, originalAmount, membershipDiscount, hasMembershipDiscount, qrCodeType, className, userReferenceNumber } = req.body;
