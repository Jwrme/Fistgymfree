      ...
      messages: [
        ...
        },
        {
          ...
          content: [
            {
              type: "text",
              text: `⚠️ FIRST: Verify this is a REAL GCASH PAYMENT RECEIPT!

If this image is NOT a GCash mobile app screenshot showing a payment transaction, immediately flag it:
- Set "isLegitimate": false
- Set "confidence": 0
- Add red flag: "NOT A GCASH RECEIPT"
- Set "paymentMethod": "Invalid/Not GCash"

Respond with ONLY a valid JSON object (no markdown, no code blocks):

{
  "isLegitimate": boolean (true if this is a real, unedited GCash receipt),
  "paymentMethod": string (e.g., "GCash", "Maya", "Bank Transfer", "Invalid/Not GCash"),
...
MUST BE A GCASH RECEIPT WITH:
✓ GCash mobile app interface (green/blue theme)
✓ "Send Money" or "Money Sent" header
✓ Clear transaction amount
✓ Transaction reference number (9 digits)
✓ Recipient name visible
✓ Transaction date/time

REJECT IF:
✗ Table, spreadsheet, or report
✗ Web page or admin panel
✗ Random screenshot or photo
✗ Not from GCash app
✗ Chat messages or text
...
- Text that doesn't match GCash's UI
- AI-generated appearance

Be EXTREMELY strict: If this is not a genuine GCash receipt screenshot, mark it as NOT legitimate.`
            },
            {
              type: "image_url",
              image_url: {
