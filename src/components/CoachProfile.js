            ...
            <div style={{ background: '#fff', color: '#181818', borderRadius: 0, paddingBottom: 40, marginTop: -45 }}>
                <main className="coach-main" style={{ paddingTop: 80 }}>
                    ...
                    {totalRatings > 0 && (() => {
                        ...
                        const startIdx = (reviewsPage - 1) * REVIEWS_PER_PAGE;
                        const currentReviews = ratings.slice(startIdx, startIdx + REVIEWS_PER_PAGE);
                        ...
                        return (
                            <section className="coach-reviews" style={{ marginTop: '40px' }}>
                                ...
                                {totalPages > 1 && (
                                    <div style={{ 
                                        ...
                                        <button
                                            ...
                                            style={{
                                                background: reviewsPage === 1 ? '#e9ecef' : '#2c3e50',
                                                color: reviewsPage === 1 ? '#6c757d' : '#fff',
                                                border: 'none',
                                                borderRadius: '6px',
                                                padding: '8px 16px',
                                                fontSize: '14px',
                                        ...
                                        <button
                                            ...
                                            style={{
                                                background: reviewsPage === totalPages ? '#e9ecef' : '#2c3e50',
                                                color: reviewsPage === totalPages ? '#6c757d' : '#fff',
                                                border: 'none',
                                                borderRadius: '6px',
                                                padding: '8px 16px',
                                                fontSize: '14px',
                                ...
                                <div style={{ 
                                    ...
                                    Showing {currentReviews.length} of {totalRatings} review{totalRatings !== 1 ? 's' : ''}
                                </div>
                            </section>
                        );
                    })()}
