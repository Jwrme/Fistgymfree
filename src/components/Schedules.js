...
const Schedules = () => {
    ...
    if (userType === 'user') {
        ...
        }, [paymentProof, selectedCoach, selectedSlot, acceptTerms, referenceNumber, selectedClassForModal, currentSelectedClass, openClass, paymentSettings, membershipApproved, user]);
        ...
        }, [showPaymentModal, selectedSlot?.class, selectedClassForModal, currentSelectedClass, openClass, paymentSettings.classRates, paymentSettings.classMembershipQrCodes, paymentSettings.classQrCodes, membershipApproved, handleFileUpload, paymentProof, referenceNumber, acceptTerms, handlePaymentSubmit]);
                                        ...
                                        {(() => {
                                            ...
                                            return (
                                                <>
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            onMouseEnter={(e) => {
                                                                                if (!isSelected) {
                                                                                    ...
                                                                                    e.target.style.boxShadow = '0 3px 10px rgba(46,204,64,0.2)';
                                                                                }
                                                                            }}
                                                                            onMouseLeave={(e) => {
                                                                                if (!isSelected) {
                                                    ...
                                                    {/* Step 2b: Select Time Slots for Selected Date */}
                                                    {selectedPackageDate && (
                                                        <div style={{ marginBottom: 20 }}>
                                                            <h5 style={{ color: '#145a32', marginBottom: 12, fontSize: 16, fontWeight: 'bold' }}>
                                                                🕐 Step 2b: Choose Time Slots for {formatDate(selectedPackageDate)}
                                                            </h5>
                                                            <div style={{
                                                                display: 'grid',
                                                                    ...
                                                                    .map((slot, slotIdx) => {
                                                                        ...
                                                                        return (
                                                                            <button
                                                                                ...
                                                                                onMouseEnter={(e) => {
                                                                                    if (!isBooked && !isSelected && !(isMaxReached && !isSelected)) {
                                                                                        e.target.style.borderColor = '#2ecc40';
                                                                                        e.target.style.transform = 'translateY(-1px)';
                                                                                        e.target.style.boxShadow = '0 3px 10px rgba(46,204,64,0.2)';
                                                                                    }
