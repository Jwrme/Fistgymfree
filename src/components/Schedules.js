...
const Schedules = () => {
    ...
    const submitRating = async (ratingData) => {
        try {
            ...
            // Update the booking history to show that this booking has been rated
            setBookingHistory(prevHistory => 
                prevHistory.map(booking => 
                    booking._id === ratingData.bookingId || 
                    (booking.coachId === ratingData.coachId && 
                     booking.date === ratingData.date && 
                     booking.time === ratingData.time)
