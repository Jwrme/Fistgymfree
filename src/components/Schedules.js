...
const Schedules = () => {
    ...
    const handlePackagePayment = async (paymentProof) => {
        ...
        // 🆕 Validate reference number for package booking
                                ...
                                <>
                                    ...
                                    {packageBookings.length > 0 && (
                                        <div style={{ marginBottom: 20 }}>
                                            ...
                                            {/* 🆕 Reference Number Input for Package */}
                            ...
                            <div style={{ display: 'flex', gap: 12, justifyContent: 'center' }}>
                                <button
                                    onClick={() => {
                                        ...
                                        setPackageStep(1);
                                        setSelectedPackageCoach(null);
                                        setSelectedPackageDate(null); // 🆕 Clear selected date
                                        setReferenceNumber(''); // 🆕 Clear reference number
                                    }}
                                    style={{
                                        background: '#6c757d',
                                ...
                                {packageStep === 2 && (
                                    <button
                                        ...
                                        disabled={packageBookings.length === 0 || !paymentProof || !acceptPackageTerms || !referenceNumber || referenceNumber.length !== 9}
                                        style={{
                                            background: (packageBookings.length === 0 || !paymentProof || !acceptPackageTerms || !referenceNumber || referenceNumber.length !== 9) ? '#ccc' : '#2ecc40',
                                            color: '#fff',
                                            border: 'none',
                                            borderRadius: 8,
                                            padding: '10px 20px',
