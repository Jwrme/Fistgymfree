                                ...
                                <>
                                    ...
                                    <div style={{ marginBottom: 20 }}>
                                        {(() => {
                                            ...
                                            return (
                                                <>
                                                    {/* Step 2a: Select Date First */}
                                                    <div style={{ marginBottom: 24 }}>
                                                        <h5 style={{ color: '#145a32', marginBottom: 16, fontSize: 18, fontWeight: 'bold', textAlign: 'center' }}>
                                                            📅 First, Choose a Date
                                                        </h5>
                                                        <div style={{
                                                            display: 'grid',
                                                            ...
                                                            {uniqueDates.length === 0 ? (
                                                                <p style={{ textAlign: 'center', color: '#666', gridColumn: '1 / -1', fontSize: 16, fontStyle: 'italic' }}>
                                                                ...
                                                                uniqueDates.map(dateKey => {
                                                                    ...
                                                                    return (
                                                                        <button
                                                                            key={dateKey}
                                                                            onClick={() => {
                                                                                if (selectedPackageDate === dateKey) {
                                                                            ...
                                                                            style={{
                                                                                ...
                                                                                border: `3px solid ${isSelected ? '#2ecc40' : '#e9ecef'}`,
                                                                                borderRadius: 12,
                                                                                padding: '16px 12px',
                                                                                fontSize: 15,
                                                                                ...
                                                                                alignItems: 'center',
                                                                                justifyContent: 'center',
                                                                                boxShadow: isSelected ? '0 6px 20px rgba(46,204,64,0.4)' : '0 2px 8px rgba(0,0,0,0.1)',
                                                                            ...
                                                                            onMouseEnter={(e) => {
                                                                                if (!isSelected) {
                                                                                    ...
                                                                                    e.target.style.boxShadow = '0 4px 16px rgba(46,204,64,0.25)';
                                                                                }
                                                                            }}
                                                                            onMouseLeave={(e) => {
                                                                                if (!isSelected) {
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <div style={{
                                                                                fontSize: 12,
                                                                                opacity: 0.9,
                                                                                background: isSelected ? 'rgba(255,255,255,0.2)' : 'rgba(46,204,64,0.1)',
                                                                                padding: '4px 8px',
                                                                                borderRadius: 6,
                                                                                color: isSelected ? '#fff' : '#2ecc40',
                                                                                fontWeight: 'bold'
                                                                            }}>
                                                    ...
                                                    {/* Step 2b: Show Time Slots Only When Date is Selected */}
                                                    {selectedPackageDate && (
                                                        <div style={{ marginBottom: 20 }}>
                                                            <h5 style={{
                                                                color: '#145a32',
                                                                ...
                                                                🕐 Now Choose Time Slots for {formatDate(selectedPackageDate)}
                                                            </h5>
                                                            <div style={{
                                                                display: 'grid',
                                                                ...
                                                                borderRadius: 12,
                                                                border: '3px solid #2ecc40',
                                                                boxShadow: '0 4px 16px rgba(46,204,64,0.15)'
                                                            }}>
                                                                {filteredAvail
                                                                        ...
                                                                        return (
                                                                            <button
                                                                                ...
                                                                                style={{
                                                                                    ...
                                                                                    border: isBooked ? '2px solid #dee2e6' : (isSelected ? '3px solid #2ecc40' : '2px solid #e9ecef'),
                                                                                    borderRadius: 10,
                                                                                    padding: '16px 12px',
                                                                                    fontSize: 14,
                                                                                    fontWeight: isSelected ? 'bold' : 'normal',
                                                                                    ...
                                                                                    alignItems: 'center',
                                                                                    justifyContent: 'center',
                                                                                    boxShadow: isSelected ? '0 4px 16px rgba(46,204,64,0.4)' : '0 2px 8px rgba(0,0,0,0.1)',
                                                            ...
                                                            {/* Helper text for time slot selection */}
                                                            <div style={{
                                                                textAlign: 'center',
                                                                marginTop: 16,
                                                                padding: '12px 16px',
                                                                ...
                                                                💡 Click on time slots to add them to your package. You can select up to {membershipPackages[selectedPackageClass]?.sessions} sessions.
                                                            </div>
                                                        </div>
                                                    )}
                                                </>
