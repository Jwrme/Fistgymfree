                                                ...
                                                <div style={{ border: '1px solid #eee', borderRadius: 8, padding: 16 }}>
                                                    ...
                                                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                                                        {uniqueDates.map((date, dateIdx) => {
                                                            ...
                                                            const isSelected = selectedPackageDate === date;
                                                            ...
                                                            return (
                                                                <button
                                                                    ...
                                                                    style={{
                                                                        background: availableSlotsForDate.length === 0 ? '#f8f9fa' : (isSelected ? '#2ecc40' : '#fff'),
                                                                        color: availableSlotsForDate.length === 0 ? '#6c757d' : (isSelected ? '#fff' : '#145a32'),
                                                                        border: availableSlotsForDate.length === 0 ? '1px solid #6c757d' : (isSelected ? '1px solid #2ecc40' : '1px solid #145a32'),
                                                                        borderRadius: 6,
                                                                        padding: '12px 16px',
                                                                        fontSize: 14,
                                                                        fontWeight: isSelected ? 'bold' : 'normal',
                                                                        cursor: availableSlotsForDate.length === 0 ? 'not-allowed' : 'pointer',
                                                                        opacity: availableSlotsForDate.length === 0 ? 0.6 : 1,
                                                                        transition: 'all 0.2s ease',
                                                                        minWidth: '120px',
                                                                        textAlign: 'center'
                                                                    }}
