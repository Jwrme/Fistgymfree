        ...
        const handlePaymentSubmit = async () => {
          ...
          try {
            if (isMultiSlotBooking) {
              ...
              const promises = bookingSlots.map(async (booking) => {
                const payload = {
                  userId: user.username,
                ...
                console.log('Multi-slot payload:', payload);
                ...
                const data = await res.json();
                console.log('Multi-slot response:', data);
                return data;
              });
              ...
              if (allSuccessful) {
                ...
                alert('❌ Some bookings failed to submit. Please try again.');
              }
            } else {
