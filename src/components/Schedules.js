...
const Schedules = () => {
    ...
    const [selectedHistoryForFeedback, setSelectedHistoryForFeedback] = useState(null);
    const [clientFeedbackSubmitting, setClientFeedbackSubmitting] = useState(false);
    ...
    if (userType === 'coach') {
        ...
        // Function to handle client feedback submission
        const handleClientFeedbackSubmit = async () => {
            ...
            setClientFeedbackSubmitting(true);
            try {
                const response = await fetch('http://localhost:3001/api/client/send-feedback', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
                    body: JSON.stringify({
                        ...
                        coachId: selectedHistoryForFeedback.coachId,
                        coachName: selectedHistoryForFeedback.coachName,
                        bookingDate: selectedHistoryForFeedback.date,
                        bookingTime: selectedHistoryForFeedback.time,
                        bookingClass: selectedHistoryForFeedback.class,
                        feedback: clientFeedbackText.trim()
                    })
                });
                ...
                if (data.success) {
                    ...
                    setSelectedHistoryForFeedback(null);
                } else {
                    alert('Failed to send feedback: ' + (data.error || 'Unknown error'));
                }
            } catch (error) {
                ...
                setClientFeedbackSubmitting(false);
            }
        };

        // Function to show client feedback modal
        const openClientFeedbackModal = (historyItem) => {
            setSelectedHistoryForFeedback(historyItem);
                                        ...
                                        <ul style={{ listStyle: 'none', padding: 0 }}>
                                            ...
                                            <div key={idx} style={{ background: '#e8f5e8', padding: 12, borderRadius: 8, marginBottom: 8, border: '1px solid #c3e6c3' }}>
                                                ...
                                                <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
                                                    ...
                                                    <button
                                                        onClick={() => openClientFeedbackModal(h)}
                                                        style={{
                                                            background: '#17a2b8',
                                                            color: '#fff',
                                                            border: 'none',
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <h3 style={{ 
                                ...
                                marginBottom: 16, 
                                fontFamily: 'Courier New, Courier, monospace',
                                borderBottom: '2px solid #2ecc40',
                                paddingBottom: 8
                            }}>
                                Send Feedback to Coach
                            </h3>
                            
                            {selectedHistoryForFeedback && (
                                <div style={{ 
                                    background: '#f8f9fa', 
                                    padding: 12, 
                                    borderRadius: 8, 
                                    ...
                                    <strong>Coach:</strong> {selectedHistoryForFeedback.coachName}<br/>
                                    <strong>Class:</strong> {selectedHistoryForFeedback.class}<br/>
                                    <strong>Date:</strong> {new Date(selectedHistoryForFeedback.date).toLocaleDateString()} at {selectedHistoryForFeedback.time}
                                </div>
                            )}
                            ...
                            <textarea
                                ...
                                placeholder="Write your feedback for the coach here..."
                                style={{
                                    width: '100%',
                                    height: 120,
                                    padding: 12,
                            ...
                            <div style={{ 
                                ...
                                <button
                                    ...
                                    disabled={clientFeedbackSubmitting}
                                    style={{
                                        background: '#6c757d',
                                        color: '#fff',
                                        border: 'none',
                                        ...
                                        padding: '10px 20px',
                                        fontWeight: 'bold',
                                        cursor: clientFeedbackSubmitting ? 'not-allowed' : 'pointer',
                                        opacity: clientFeedbackSubmitting ? 0.6 : 1
                                    }}
                                >
                                    Cancel
                                </button>
                                <button
                                    onClick={handleClientFeedbackSubmit}
                                    disabled={!clientFeedbackText.trim() || clientFeedbackSubmitting}
                                    style={{
                                        background: (clientFeedbackText.trim() && !clientFeedbackSubmitting) ? '#2ecc40' : '#ccc',
                                        color: '#fff',
                                        border: 'none',
                                        borderRadius: 8,
                                        padding: '10px 20px',
                                        fontWeight: 'bold',
                                        cursor: (clientFeedbackText.trim() && !clientFeedbackSubmitting) ? 'pointer' : 'not-allowed'
                                    }}
                                >
                                    {clientFeedbackSubmitting ? 'Sending...' : 'Send Feedback'}
                                </button>
                            </div>
                        </div>
                    </div>
